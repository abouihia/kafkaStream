...
public class SchemaProducer  <T>  implements Closeable {


    private KafkaProducer<String, T> producer ;
    static final Random random = new Random();
    public static  final  String inputTopic = "sr-input-topic";
    ...
    static void main(String[] args) {
        ...
        ProductOrder.Builder productOrderBuilder = ProductOrder.newBuilder();
        ...
        try(  SchemaProducer<ProductOrder> stringBasicProducer  = new SchemaProducer<>()){

            stringBasicProducer.publishElementGeneric(productOrders, inputTopic);
        }catch (IOException e) {
