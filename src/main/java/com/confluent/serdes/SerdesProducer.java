...
import com.confluent.error.ErrorProducer;
...
public class SerdesProducer <T>  implements Closeable {

    private KafkaProducer<String, T> producer ;


    public SerdesProducer(){
    ...
    public static void main() {
        ...
        try(  SerdesProducer<String> stringBasicProducer  = new SerdesProducer<>()){
            stringBasicProducer.publishElementGeneric(rawRecords, "serdes-input-topic");
        }catch (IOException e) {
