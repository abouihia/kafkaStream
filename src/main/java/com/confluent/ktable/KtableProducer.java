...
import com.confluent.basic.BasicProducer;
...
public class KtableProducer<T> implements Closeable {
    ...
    public static void main(String[] args) {
        ...
        try(  KtableProducer<String>  stringBasicProducer  = new KtableProducer<>()){
            stringBasicProducer.publishElementGeneric(rawRecords, "ktable-input");
        }catch (IOException e) {
