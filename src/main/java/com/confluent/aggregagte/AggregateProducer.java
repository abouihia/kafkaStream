...
import com.confluent.processor.ProcessorProducer;
...
public class AggregateProducer<T>  implements Closeable {

    private KafkaProducer<String, T> producer ;


    public  AggregateProducer(){
    ...
    public static void main() {
        ...
        try( AggregateProducer aggregateProducer = new AggregateProducer()){
