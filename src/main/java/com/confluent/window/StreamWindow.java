...
public class StreamWindow {
    ...
    public static final String APPLICATION_ID_FOR_MY_STREAM = "windowed-streams";
    ...
    static void main(String[] args) throws IOException {
        ...
        LauncherUtils.createStream(streamsProps, topologyWindow( streamsProps,  inputTopic, outputTopic));

    }


    public static Topology topologyWindow(Properties streamsProps , final String inputTopic , String outputTopic){
        ...
        final KStream<String, ElectronicOrder> electronicStream =
                streamsBuilder.stream(inputTopic, Consumed.with(Serdes.String(), electronicSerde))
