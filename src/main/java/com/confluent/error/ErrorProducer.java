...
public class ErrorProducer<T>  implements Closeable {
    ...
    public static void main() {
        ...
        try(  ErrorProducer<String> stringBasicProducer  = new ErrorProducer<>()){
            stringBasicProducer.publishElementGeneric(rawRecords, "streams-error-input");
        }catch (IOException e) {
